...
let MkAllocationInstructionNoAllocsGrp (allocAccount:AllocAccount, commissionData:CommissionData, settlInstructionsData:SettlInstructionsData) : AllocationInstructionNoAllocsGrp = {
    AllocAccount = allocAccount
    AllocAcctIDSource = None
    MatchStatus = None
    AllocPrice = None
