...
let MkAllocationInstruction (allocID:AllocID, allocTransType:AllocTransType, allocType:AllocType, allocNoOrdersType:AllocNoOrdersType, side:Side, instrument:Instrument, instrumentExtension:InstrumentExtension, financingDetails:FinancingDetails, quantity:Quantity, avgPx:AvgPx, spreadOrBenchmarkCurveData:SpreadOrBenchmarkCurveData, parties:Parties, tradeDate:TradeDate, stipulations:Stipulations, yieldData:YieldData) : AllocationInstruction = {
    ...
    TotNoAllocs = None
    LastFragment = None
    AllocationInstructionNoAllocsGrp = None
  }
...
let MkCollateralRequest (collReqID:CollReqID, collAsgnReason:CollAsgnReason, transactTime:TransactTime, parties:Parties, financingDetails:FinancingDetails, instrumentLeg:InstrumentLeg, spreadOrBenchmarkCurveData:SpreadOrBenchmarkCurveData, stipulations:Stipulations) : CollateralRequest = {
    CollReqID = collReqID
...
let MkCollateralReport (collRptID:CollRptID, collStatus:CollStatus, parties:Parties, financingDetails:FinancingDetails, instrumentLeg:InstrumentLeg, spreadOrBenchmarkCurveData:SpreadOrBenchmarkCurveData, stipulations:Stipulations, settlInstructionsData:SettlInstructionsData) : CollateralReport = {
    CollRptID = collRptID
    CollInquiryID = None
...
let MkCollateralInquiry (parties:Parties, financingDetails:FinancingDetails, instrumentLeg:InstrumentLeg, spreadOrBenchmarkCurveData:SpreadOrBenchmarkCurveData, stipulations:Stipulations, settlInstructionsData:SettlInstructionsData) : CollateralInquiry = {
    CollInquiryID = None
...
let MkCollateralInquiryAck (collInquiryID:CollInquiryID, collInquiryStatus:CollInquiryStatus, parties:Parties, financingDetails:FinancingDetails, instrumentLeg:InstrumentLeg) : CollateralInquiryAck = {
